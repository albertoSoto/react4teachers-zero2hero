...
Para implementar las diferentes fases del ciclo de vida, se utilizara un concepto denominado HoC (High Order Component) a traves de los conocidos Reactr Hooks.
